...
// Source: ./internal/pkg/db/database.go
...
func (m *MockDBops) Get(ctx context.Context, dst interface{}, query string, args ...interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockDBopsMockRecorder) Get(ctx, dst, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDBops) Select(ctx context.Context, dst interface{}, query string, args ...interface{}) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, dst, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockDBopsMockRecorder) Select(ctx, dst, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, dst, query}, args...)
